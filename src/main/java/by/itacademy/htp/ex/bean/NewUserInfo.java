...
public class NewUserInfo implements Serializable {
	...
	public NewUserInfo(int userID, String name, String surname, String login, String email) {
		super();
	...
	public NewUserInfo(int userID, String name, String surname, String login, String email, String role) {
		super();
	...
	public NewUserInfo(int userID, String name, String surname, String email) {
		super();
	...
	public String toString() {
		return getClass().getName()+"NewUserInfo [userID=" + userID + ", name=" + name + ", surname=" + surname + ", login=" + login
